    ...
    <div className="overflow-auto h-[calc(100vh-20px)] bg-gray-700/70 w-full">
      <div className="bg-gray-300 shadow-lg top-0 sticky">
        <nav className="container mx-auto max-w-[100vw] xl:w-[60vw] shadow-lg p-3 bg-gray-500 flex items-center justify-between">
          <Link
            href="/gigme/social"
            className={`w-[60px] rounded-full animate-pulse bg-gray-400 h-[20px]`}
          ></Link>
          <span className="flex items-center">
            <div className="flex flex-grow gap-5 items-center">
              <Link href="/gigme/social" className="text-white">
                <div className="bg-gray-400/40 animate-pulse w-[20px] h-[20px] rounded-full"></div>
              </Link>
      ...
      <div className="h-[calc(100vh-20px)]">
        <Box className="flex items-center   justify-around md:justify-self-auto shadow-md bg-inherit h-[200px] w-full md:h-[400px]">
          <Box className="flex gap-2 items-center h-full animate-pulse">
            <div className=" flex justify-center animate-pulse mr-[40px] mt-7 items-center bg-gray-400/20 rounded-full w-[160px] h-[160px]"></div>
            <div className="flex flex-col">
              <div className="h-[200px] w-[120px]  flex flex-col gap-2 mt-[160px] ">
                <div className="flex flex-col gap-4 animate-pulse h-[20px] bg-gray-400/20 w-[170px] z-50  -ml-[40px]"></div>
                <div className="flex flex-col gap-4 animate-pulse h-[20px] bg-gray-400/20 w-[170px] z-50 -ml-[40px]"></div>
              </div>{" "}
              <div className="w-[73px] h-[20px] animate-pulse -mt-[140px] mb-[85px] bg-gray-400/20"></div>
            </div>
          </Box>
          <div className="animate-pulse hidden md:flex md:flex-col ">
            <div className="w-[60px] animate-pulse"></div>
          </div>
        </Box>
        <div className="h-[70px] w-full flex flex-col gap-2 mt-10">
          <div className="flex flex-col gap-4 h-[20px] animate-pulse bg-gray-400/20 w-full z-50  "></div>
          <div className="flex flex-col gap-4 h-[20px] animate-pulse bg-gray-400/20 w-full z-50 "></div>
        </div>{" "}
